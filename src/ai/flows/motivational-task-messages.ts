...
const prompt = ai.definePrompt({
  ...
  - Task Progress: 75%, Task Name: "Разработать карточку персонажа", User Name: "Боб" -> "Ты почти у цели, Боб! 75% карточки персонажа уже готово. Еще несколько штрихов, и твое приключение в MoneyQuest начнется!"
